  ...
  return (
    <>
      ...
      <div className="container-fluid section-color">
        <div className="row">
          <h3
            className="voting-instruction-heading"
            style={{ color: "rgb(45, 45, 73)" }}
          >
          ...
          <div className="col-md-4 mt-3">
            <svg
              ...
              fill="currentColor"
              className="bi bi-hand-index-thumb icon"
              style={{ color: "rgb(45, 45, 73)" }}
              viewBox="0 0 16 16"
            >
          ...
          <div className="col-md-4 mt-3">
            <svg
              ...
              fill="currentColor"
              style={{ color: "rgb(45, 45, 73)" }}
              className="bi bi-check2-circle icon"
              viewBox="0 0 16 16"
            >
          ...
          <div className="col-md-4 mt-3">
            <svg
              ...
              fill="currentColor"
              style={{ color: "rgb(45, 45, 73)" }}
              className="bi bi-bar-chart icon"
              viewBox="0 0 16 16"
            >
